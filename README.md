About terraform-provider-docker-feedstock
=========================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-docker-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-docker-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-docker
# for installing globally
pixi global install terraform-provider-docker
```
...
It is possible to list all of the versions of `terraform-provider-docker` available on your platform:
...
```
pixi search terraform-provider-docker --channel conda-forge
```
